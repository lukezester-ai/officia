...
export const aiTools: AiCapability[] = [
  ...
  { key: 'manageInventory', label: 'Manage inventory', owner: 'inventory', mode: 'write', level: 4, risk: 'medium', requiresHumanReview: true, writesData: true, connectedSystems: ['inventory_items', 'inventory_movements', 'tasks', 'ai_inbox', 'journal_entries'], status: 'live' },
  { key: 'scanInventoryCode', label: 'Scan inventory barcode', owner: 'inventory', mode: 'workflow', level: 4, risk: 'medium', requiresHumanReview: true, writesData: true, connectedSystems: ['inventory_items', 'inventory_movements', 'ai_inbox'], status: 'live' },
