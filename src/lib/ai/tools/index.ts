...
export const tools = {
  ...
  bankMatch: buildBankMatchTool(dummyId, dummyId),
  createExpense: buildCreateExpenseTool(dummyId, dummyId),
  createJournalEntry: buildCreateJournalEntryTool(dummyId, dummyId),
  manageHR: buildManageHRTool(dummyId, dummyId),
  manageInventory: buildManageInventoryTool(dummyId, dummyId),
  ...
  processInbox: buildProcessInboxTool(dummyId, dummyId),
