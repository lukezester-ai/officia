...
const capabilities = [
  ...
  },
  {
    icon: Landmark,
    title: 'Банка (демо)',
    text: 'Демонстрационна синхронизация за тестване. Реална връзка чрез PSD2 е в разработка.',
  },
  {
    icon: Shield,
    title: 'Сигурност',
    text: 'Защитен вход, изолирани фирмени пространства и PostgreSQL. Без подвеждащи обещания за обслужване.',
  },
];
