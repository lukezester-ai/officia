...
export function ExportButtons({ data, reportType, period, companyName }: ExportButtonsProps) {
  const name = companyName || process.env.NEXT_PUBLIC_DEFAULT_COMPANY_NAME || "Officia";
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={() => ReportExporter.exportToPDF(data, reportType, period, name)}
