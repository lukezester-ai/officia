...
const faqs = [
  {
    ...
    answer: "Officia поддържа ДДС дневници и ZIP експорт за НАП като работещ начален процес. Директното подаване към НАП, подписът с КЕП и официалната проверка се активират само след реални данни за достъп до НАП, сертификат и потвърдена схема."
  },
  {
    question: "Мога ли да импортирам от друга програма?",
    answer: "В момента има CSV обработка за банкови извлечения и подготвена основа за внос. Пълният внос на начални салда, номенклатури и контрагенти е отделен процес и трябва да се провери с реални файлове."
  },
  {
    question: "Как работи AI асистентът за документи?",
    answer: "Асистентът може да извлича данни от изображения чрез визуалния модел на Claude. Обработката на PDF, разпознаването на текст и предложеното осчетоводяване включват човешки преглед при рискови действия."
  },
  {
    question: "Мога ли да използвам Officia за множество фирми?",
    answer: "Системата разделя данните по фирмени пространства. Превключването между много фирми от един профил изисква допълнителен превключвател, ако един потребител управлява повече от една фирма."
  },
  {
    question: "Сигурни ли са данните ми?",
    answer: "Достъпът е защитен чрез Clerk и проверки на фирменото пространство. Сигурността в работна среда зависи и от настройките на хостинга, базата данни, ограниченията по редове, резервните копия и политиките за достъп."
  },
  {
    question: "Има ли безплатен тестов период?",
    answer: "Публичната регистрация предлага пробен период, а реалните ограничения по пробен период и абонамент се управляват чрез Stripe и правилата на плана."
  }
];
