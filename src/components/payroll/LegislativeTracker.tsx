  ...
  params: [
    {
      ...
      prevValue: 1077,
      prevYear: 2025,
      source: "https://mlsp.government.bg",
      description: "Минимална работна заплата за 2026 г. в евро.",
      checkFn: (salary: number) => salary > 0 && salary < 620.2,
      warningText: (name: string) => `${name} получава под минималната заплата за 2026 г. (620,20 €)`,
    },
    {
      id: "max_ins",
      ...
      prevYear: 2026,
      source: "https://noi.bg",
      description: "Максимален осигурителен доход от август 2026 г.",
      checkFn: (salary: number) => salary > 2300,
      warningText: (name: string) => `${name}: брутото е над тавана 2 300 € и осигуровките се смятат до него`,
    },
    {
      id: "non_taxable",
