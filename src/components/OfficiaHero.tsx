...
export default function OfficiaHero({ lang, copy }: { lang: string; copy: HeroCopy }) {
  ...
  return (
    <div className="officia-hero relative min-h-[100dvh] overflow-hidden text-[#F8FAFC]" dir={rtl ? "rtl" : "ltr"}>
      <style>{`
        .officia-hero {
          --officia-bg: #0B1220;
          --officia-ink: #F8FAFC;
          ...
          font-family: var(--font-fira-sans), 'IBM Plex Sans Arabic', sans-serif;
        }
        ...
        .officia-hero__product {
          ...
          border-block-start: 1px solid rgba(248, 250, 252, 0.08);
          border-inline-start: 1px solid rgba(248, 250, 252, 0.06);
          box-shadow: -40px -20px 80px rgba(0, 0, 0, 0.35);
          overflow: hidden;
          transform: perspective(1400px) rotateY(var(--product-tilt, -8deg)) rotateX(4deg);
          transform-origin: var(--product-origin, right bottom);
        }

        .officia-hero[dir="rtl"] {
          --product-tilt: 8deg;
          --product-origin: left bottom;
        }
        ...
        .officia-hero__product-rail {
          ...
          bottom: 0;
          width: 18%;
          border-inline-end: 1px solid rgba(248, 250, 252, 0.05);
      ...
      <nav className="relative z-20 border-b border-white/8 bg-[#0B1220]/55 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 md:h-20">
          ...
          <MobileMenu lang={lang} labels={{ features: copy.features, pricing: copy.pricing, capabilities: copy.capabilities, signIn: copy.signIn, startFree: copy.startFree }} />
        </div>
      </nav>
        ...
        <section className="mx-auto w-full max-w-7xl">
          <div className="max-w-xl md:max-w-2xl">
            <motion.h1
              ...
              style={{ fontSize: "clamp(2.6rem, 9vw, 6.2rem)", lineHeight: 0.95 }}
            >
              {copy.brand}
            </motion.h1>
            ...
            >
              ...
              >
                {copy.startFree}
                <CtaArrow className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5" />
              </Link>
              <Link
                href={`/${lang}/dashboard`}
