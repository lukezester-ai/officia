      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-2xl font-bold">Pari i Potok</h1><p className="text-zinc-400 text-sm">Cash Flow Statement</p></div>
          </div>
        </div>
        <div className="bg-violet-950/20 border border-violet-500/20 rounded-2xl p-12 text-center">
          ...
          <h3 className="font-bold text-lg mb-2">Cash Flow - Skoro</h3>
          <p className="text-zinc-400 text-sm max-w-md mx-auto">Otchetat za parichny potok she bude implementiran v sledvashtata faza. She izchislyava dvijenieto po smetki 501 i 503.</p>
        </div>
      </div>
    </div>
  );
